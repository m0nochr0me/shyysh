...
class ContactView(Frame):
    def __init__(self, screen, model):
        ...
        layout.add_widget(CheckBox('', 'Compression', 'compression'))
        layout.add_widget(CheckBox('', 'Forward X', 'fwd_x'))
        layout.add_widget(CheckBox('', 'Forward Agent', 'fwd_a'))
        layout.add_widget(CheckBox('', 'Allow Remote Port Conn', 'allow_rpc'))
        layout.add_widget(CheckBox('', 'No exec', 'no_exec'))
        layout.add_widget(Divider(height=2))
